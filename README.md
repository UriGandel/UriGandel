...
*   🏆 **Platanus Hack 2026:** Selected participant, building and deploying fast-paced tech solutions.
*   🕹️ **Game Dev:** Recently built *Gravity Duel* (Neon Void), a lightweight 2-player arcade game under 50KB using Phaser 3.
...
### **AI & Machine Learning**
*   **LLMs:** DeepSeek, GPT-5, Qwen (Local models)
*   **Specialized Models:** FinBERT, XGBoost
*   **Concepts:** Multimodal AI integration, Data Scraping, Microservices
